      ...
      <Wrapper>
        <Wrapper.Col>
          ...
          <Wrapper.Box>
            ...
            <Desc>
              {state?.yearBuilt ? state?.houseDetails?.yearBuilt : "no year"}
            </Desc>
          </Wrapper.Box>
        </Wrapper.Col>
        <Wrapper.Col>
        ...
        <Wrapper.Col>
          <Wrapper.Box>
            ...
            <Desc>
              {state?.category?.name ? state?.category?.name : "no name"}
            </Desc>
          </Wrapper.Box>
          <Wrapper.Box>
